...
export class StoreMapper {
  static toDomain(prismaStore: StoreWithSubscription): Store {
    return new Store({
      ...
      whatsappTemplate: prismaStore.whatsappTemplate,
      exchangeRateMode: prismaStore.exchangeRateMode,
      exchangeRateCode: prismaStore.exchangeRateCode,
      customRate: prismaStore.customRate ? Number(prismaStore.customRate) : null,
